...
import { createPayment, paymentCallback, createPayOSPaymentLink, payOsPaymentCallbackSuccess, payOsPaymentCallbackFailed } from '../Controllers/payments.controllers.js';
 ...
 * /payments/payOs:
 *   post:
 *     summary: Create a new payment via PayOs.
 *     description: Initiate a payment transaction for an order using PayOs.
 *     tags:
 *       - Payments
 *     requestBody:
 *       required: true
 ...
 *     responses:
 *       200:
 *         description: Returns a URL to redirect to PayOS.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   example: Error details
 */
router.post('/payOs', createPayOSPaymentLink);
...
router.get('/payOs/success', payOsPaymentCallbackSuccess);

router.get('/payOs/failed', payOsPaymentCallbackFailed);
